...
public class exercicio3 {
	...
	public static void main(String [] args){
		...
		int escolha = Integer.parseInt(JOptionPane.showInputDialog(null, "Seja bem vindo :D\n\nDigite 1 para calcular a área de uma figura"
				+ "\nDigite 2 para calcular o volume de uma figura"));
	
		if (escolha == 1){
			int escolha2 = Integer.parseInt(JOptionPane.showInputDialog(null, "Escolha uma das opções abaixo\n\n"
	...
	public static void circulo(){
		...
		System.out.print("o área do circulo é: "+raio);
	}
	...
	public static void retangulo(){
		 ...
		 System.out.println("o área do retangulo é: " +area);
	}
